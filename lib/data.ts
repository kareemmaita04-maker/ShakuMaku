...
export const PRODUCTS: Product[] = [
  {
    id: 'p1', name: 'Kitchen Sink', cat: 'Hummus & Dips', size: '8 oz', price: 8,
    desc: 'Everything we love in one jar — roasted garlic, sun-dried tomato, jalapeño, and fresh herbs. Our most loaded hummus.',
    ingredients: 'Chickpeas, roasted garlic, sun-dried tomato, jalapeño, cilantro, basil, tahini, lemon juice, olive oil, sea salt',
  ...
  {
    id: 'p2', name: 'Cali Dip', cat: 'Hummus & Dips', size: '8 oz', price: 8,
    desc: 'Sun-dried tomato and fresh basil — Mediterranean meets California in every scoop.',
    ingredients: 'Chickpeas, sun-dried tomato, basil, garlic, tahini, lemon juice, olive oil, sea salt',
    allergens: 'Contains sesame (tahini).',
    storage: 'Keep refrigerated at 34–40°F.', shelf: 'Best within 7 days.',
    badges: ['Vegan', 'Seed-Oil Free'], hidden: false,
  },
  {
    id: 'p3', name: 'Sneaky Flame', cat: 'Hummus & Dips', size: '8 oz', price: 8,
    desc: 'Smooth hummus with a slow-building heat from jalapeño and roasted red pepper. It sneaks up on you.',
    ingredients: 'Chickpeas, jalapeño, roasted red pepper, garlic, tahini, lemon juice, olive oil, sea salt',
    allergens: 'Contains sesame (tahini).',
    storage: 'Keep refrigerated at 34–40°F.', shelf: 'Best within 7 days.',
    badges: ['Vegan', 'Seed-Oil Free', 'Spicy'], hidden: false,
  },
  {
    id: 'p4', name: "Mo's Mix", cat: 'Hummus & Dips', size: '8 oz', price: 8,
    desc: 'Our house blend — garlicky, green and packed with cilantro and basil. A fan favorite since day one.',
    ingredients: 'Chickpeas, garlic, cilantro, basil, tahini, lemon juice, olive oil, sea salt',
    allergens: 'Contains sesame (tahini).',
    storage: 'Keep refrigerated at 34–40°F.', shelf: 'Best within 7 days.',
    badges: ['Vegan', 'Seed-Oil Free'], hidden: false,
  },
  {
    id: 'p5', name: 'Cilantro Hummus', cat: 'Hummus & Dips', size: '8 oz', price: 8,
    desc: 'Bright, herb-forward hummus with a generous hand of fresh cilantro. Simple and addictive.',
    ingredients: 'Chickpeas, cilantro, garlic, tahini, lemon juice, olive oil, sea salt',
    allergens: 'Contains sesame (tahini).',
    storage: 'Keep refrigerated at 34–40°F.', shelf: 'Best within 7 days.',
    badges: ['Vegan', 'Seed-Oil Free'], hidden: false,
  },
  {
    id: 'p6', name: 'Spinach Garlic', cat: 'Hummus & Dips', size: '8 oz', price: 8,
    desc: 'Loaded with fresh spinach and slow-roasted garlic. Green, garlicky, and impossible to stop eating.',
    ingredients: 'Chickpeas, fresh spinach, roasted garlic, tahini, lemon juice, olive oil, sea salt',
    allergens: 'Contains sesame (tahini).',
    storage: 'Keep refrigerated at 34–40°F.', shelf: 'Best within 7 days.',
    badges: ['Vegan', 'Seed-Oil Free'], hidden: false,
  },
...
export const SETTINGS = {
  ...
  deliveryZips: [
    ...
    '85042','85043','85044','85045','85048','85050','85051','85053','85054',
    // Scottsdale
    '85250','85251','85253','85254','85255','85257','85258','85259','85260','85262','85266','85268',
    // Tempe
    ...
    // Chandler
    '85224','85225','85226','85228','85248','85249',
    // Glendale
    ...
    '85374','85379','85388',
    // West Valley
    '85323','85326','85335','85338','85339','85340','85351','85353','85363','85373','85375','85395','85396',
    // NE Valley
    '85268','85331','85377',
